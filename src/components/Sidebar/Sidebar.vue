      ...
      <div class="p-1">
        ...
        <b-menu>
          <b-menu-list label="Menu">
            <b-menu-item icon="information-outline" href="http://localhost:8081/dashboard#" label="Dashboard"></b-menu-item>
            ...
            <b-menu-item active expanded icon="settings">
              ...
              <b-menu-item icon="account" href="http://localhost:8081/allitems" label="All Items"></b-menu-item>
            ...
            <b-menu-item icon="settings">
              ...
              <b-menu-item icon="account" href="http://localhost:8081/allcustomers" label="All Customers"></b-menu-item>
            ...
            <b-menu-item icon="settings">
              ...
              <b-menu-item icon="account" href="http://localhost:8081/allinvoices" label="All Invoices"></b-menu-item>
